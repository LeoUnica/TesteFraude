    ...
    <div className="space-y-4">
      ...
      {selectedCard && (
        <div className="card p-0 overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-blue-50 dark:bg-blue-900/20 flex items-center justify-between gap-2">
            <div className="flex items-center gap-2 min-w-0">
              <span className="text-lg">{selectedCard.icon}</span>
              <span className="text-sm font-semibold text-blue-900 dark:text-blue-300 truncate">{selectedCard.label}</span>
              {!cardLoading && (
                <span className="text-xs text-blue-600 dark:text-blue-400 flex-shrink-0">— {cardProposals.length} proposta(s)</span>
              )}
            </div>
            <div className="flex items-center gap-2 flex-shrink-0">
              <button
                onClick={() => exportToExcel(cardProposals, selectedCard.label)}
      ...
      {/* Fila de análise */}
      <div className="card p-0 overflow-hidden">
        <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-amber-50 dark:bg-amber-900/20 flex items-center justify-between gap-2">
          ...
          <button
            onClick={() => exportToExcel(proposals, 'fila_analise')}
            className="btn-secondary py-1.5 text-xs flex items-center gap-1"
          >
            📥 Exportar Excel
          </button>
